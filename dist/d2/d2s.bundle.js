...
/******/ (() => {
        ...
        var BitReader = /** @class */ (function () {
          function BitReader(arrBuffer) {
            ...
            typedArray.reduce(function (acc, c) {
              ...
              b.forEach(function (bit) {
                return (_this.bits[acc++] = bit);
              });
              return acc;
            }, 0);
          }
      ...
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
          ...
          char.item_bonuses = [].concat
            .apply(
              ...
              items.map(function (item) {
                return _allAttributes(item, constants);
              }),
            )
        ...
        function enhanceItem(item, mod, version, level, config, parent) {
          ...
          if (parent) {
            //socket item.
            var pt =
              constants.armor_items[parent.type] ||
              constants.weapon_items[parent.type] ||
              constants.other_items[parent.type];
          ...
          if (details) {
            ...
            item.total_nr_of_sockets = boundValue(
              item.total_nr_of_sockets,
              0,
              details.gs || item.inv_width * item.inv_height,
            );
            ...
            if (
              item.multiple_pictures &&
              details.ig &&
              details.ig.length &&
              details.ig[item.picture_id]
            ) {
            ...
            if (item.magic_prefix || item.magic_suffix) {
              if (
                item.magic_prefix &&
                ((_a = constants.magic_prefixes[item.magic_prefix]) === null ||
                _a === void 0
                  ? void 0
                  : _a.tc)
              ) {
                item.transform_color =
                  constants.magic_prefixes[item.magic_prefix].tc;
              }
              if (
                item.magic_suffix &&
                ((_b = constants.magic_suffixes[item.magic_suffix]) === null ||
                _b === void 0
                  ? void 0
                  : _b.tc)
              ) {
                item.transform_color =
                  constants.magic_suffixes[item.magic_suffix].tc;
              }
            } else if (
              item.magical_name_ids &&
              item.magical_name_ids.length === 6
            ) {
              for (var i = 0; i < 6; i++) {
                ...
                if (id) {
                  if (
                    i % 2 == 0 &&
                    constants.magic_prefixes[id] &&
                    ((_c = constants.magic_prefixes[id]) === null ||
                    _c === void 0
                      ? void 0
                      : _c.tc)
                  ) {
                    ...
                    constants.magic_suffixes[id] &&
                    ((_d = constants.magic_suffixes[id]) === null ||
                    _d === void 0
                      ? void 0
                      : _d.tc)
                  ) {
          ...
          if (
            ...
            item.displayed_magic_attributes = _enhanceAttributeDescription(
              item.magic_attributes,
              constants,
              level,
              config,
            );
            item.displayed_runeword_attributes = _enhanceAttributeDescription(
              item.runeword_attributes,
              constants,
              level,
              config,
            );
            item.combined_magic_attributes = _groupAttributes(
              _allAttributes(item, constants),
              constants,
            );
        ...
        function _enhanceAttributeDescription(
          ...
          var magic_attributes = __spreadArray(
            [],
            _magic_attributes.map(function (attr) {
          ...
          var dgrpsVal = [0, 0, 0];
          for (
            var _i = 0, magic_attributes_1 = magic_attributes;
            _i < magic_attributes_1.length;
            _i++
          ) {
          ...
          var _loop_1 = function (property) {
            ...
            if (prop == null) {
              throw new Error(
                "Cannot find Magical Property for id: ".concat(property.id),
              );
            }
            var v = property.values[property.values.length - 1];
            if (prop.ob === "level") {
            ...
            if (prop.np) {
              ...
              if (prop.s === "poisonmindam") {
                ...
                var min = Math.floor(
                  (property.values[0] * property.values[2]) / 256,
                );
                var max = Math.floor(
                  (property.values[1] * property.values[2]) / 256,
                );
              ...
              if (property.values[0] === property.values[1]) {
                ...
                if (prop.s === "item_maxdamage_percent") {
                  descString = "+%d% ".concat(
                    descString.replace(/}/gi, "").replace(/%\+?d%%/gi, ""),
                  );
                }
              }
          ...
          for (
            var _a = 0, magic_attributes_2 = magic_attributes;
            _a < magic_attributes_2.length;
            _a++
          ) {
          ...
          if (
            ...
            magic_attributes.sort(function (a, b) {
              return (
                constants.magical_properties[b.id].so -
                constants.magical_properties[a.id].so
              );
            });
          }
          for (var i = magic_attributes.length - 1; i >= 1; i--) {
            for (var j = i - 1; j >= 0; j--) {
              if (
                magic_attributes[i].description ===
                magic_attributes[j].description
              ) {
        ...
        function _descFunc(
          ...
          switch (descFunc) {
            ...
            case 11: {
              ...
              property.description = descString.replace(
                /%d/,
                (v / 100).toString(),
              );
              break;
            ...
            case 17: {
              ...
              property.description = ""
                .concat(v, " ")
                .concat(descString, " (Increases near [time])");
              break;
            }
            case 18: {
              // [value]% [string1] (Increases near [time])
            ...
            case 27: {
              ...
              if (descString) {
                ...
                property.description = ""
                  ...
                  .concat(skillStr, " ")
                  .concat(
                    clazz === null || clazz === void 0 ? void 0 : clazz.co,
                  );
              }
              break;
            }
        ...
        function _itemStatCostFromStat(stat, constants) {
          return constants.magical_properties.findIndex(function (e) {
            return e && e.s === stat;
          });
        }
        function _classFromCode(code, constants) {
          return constants.classes.filter(function (e) {
            return e.c === code;
          })[0];
        }
          ...
          if (item.socketed_items) {
            for (var _i = 0, _a = item.socketed_items; _i < _a.length; _i++) {
              ...
              if (i.magic_attributes) {
                socketed_attributes = socketed_attributes.concat.apply(
                  socketed_attributes,
                  JSON.parse(JSON.stringify(i.magic_attributes)),
                );
              }
            }
          }
        ...
        function _groupAttributes(all_attributes, constants) {
          ...
          for (
            var _i = 0, all_attributes_1 = all_attributes;
            _i < all_attributes_1.length;
            _i++
          ) {
  ...
  \******************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        var bitwriter_1 = __webpack_require__(
          /*! ../binary/bitwriter */ "./src/binary/bitwriter.ts",
        );
        var constants_1 = __webpack_require__(
          /*! ./constants */ "./src/d2/constants.ts",
        );
        ...
        function readAttributes(char, reader, mod) {
          var constants = (0, constants_1.getConstantData)(
            mod,
            char.header.version,
          );
          ...
          var attributes = constants.magical_properties.filter(
            function (val, idx) {
              return val && val.c && idx < 256;
            },
          );
          // Initial values
          ...
          if (header != "gf") {
            ...
            if (char.header.level === 1) {
              var classData = constants.classes.find(function (c) {
            ...
            throw new Error(
              "Attribute header 'gf' not found at position ".concat(
                reader.offset - 2 * 8,
              ),
            );
          }
        ...
        function writeAttributes(char, constants) {
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
              ...
              attributes = constants.magical_properties.filter(
                function (val, idx) {
                  return val && val.c && idx < 256;
                },
              );
              for (
                ...
                if (size === undefined) {
                  throw new Error(
                    "Missing CSV save bits for attribute: ".concat(property),
                  );
                }
                if (property.cVS) {
                  value <<= property.cVS;
      ...
      /***/ (__unused_webpack_module, exports) => {
        ...
        function getConstantData(mod, version) {
          if (!(mod in versionedConstants)) {
            throw new Error(
              "No constant data found for this mod "
                .concat(mod, ". Supported mods are: ")
                .concat(Object.keys(versionedConstants).join(", ")),
            );
          }
          if (!(version.toString() in versionedConstants[mod])) {
            throw new Error(
              "No constant data found for version "
                .concat(version, " of mod ")
                .concat(mod, ". Supported versions are: ")
                .concat(Object.keys(versionedConstants[mod]).join(", ")),
            );
          }
  ...
  \***********************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        var header_1 = __webpack_require__(
          /*! ./header */ "./src/d2/header.ts",
        );
        var attributes_1 = __webpack_require__(
          /*! ./attributes */ "./src/d2/attributes.ts",
        );
        var bitreader_1 = __webpack_require__(
          /*! ../binary/bitreader */ "./src/binary/bitreader.ts",
        );
        var bitwriter_1 = __webpack_require__(
          /*! ../binary/bitwriter */ "./src/binary/bitwriter.ts",
        );
        var skills_1 = __webpack_require__(
          /*! ./skills */ "./src/d2/skills.ts",
        );
        var items = __importStar(
          __webpack_require__(/*! ./items */ "./src/d2/items.ts"),
        );
        var constants_1 = __webpack_require__(
          /*! ./constants */ "./src/d2/constants.ts",
        );
        var attribute_enhancer_1 = __webpack_require__(
          /*! ./attribute_enhancer */ "./src/d2/attribute_enhancer.ts",
        );
        var defaultConfig = {
          extendedStash: false,
          sortProperties: true,
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 1:
                  ...
                  return [
                    4 /*yield*/,
                    (0, header_1.readHeaderData)(char, reader, mod),
                  ];
                case 2:
                  //could load constants based on version here
                  _a.sent();
                  return [
                    4 /*yield*/,
                    (0, attributes_1.readAttributes)(char, reader, mod),
                  ];
                case 3:
                  _a.sent();
                  return [
                    4 /*yield*/,
                    (0, skills_1.readSkills)(char, reader, mod),
                  ];
                case 4:
                  _a.sent();
                  return [
                    4 /*yield*/,
                    items.readCharItems(char, reader, mod, config),
                  ];
                case 5:
                  _a.sent();
                  return [
                    4 /*yield*/,
                    items.readCorpseItems(char, reader, mod, config),
                  ];
                case 6:
                  _a.sent();
                  ...
                  return [
                    4 /*yield*/,
                    items.readMercItems(char, reader, mod, config),
                  ];
                case 7:
                  _a.sent();
                  return [
                    4 /*yield*/,
                    items.readGolemItems(char, reader, mod, config),
                  ];
                case 8:
                  _a.sent();
                  _a.label = 9;
                case 9:
                  return [
                    4 /*yield*/,
                    (0, attribute_enhancer_1.enhanceAttributes)(
                      char,
                      mod,
                      char.header.version,
                      config,
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  ...
                  return [
                    4 /*yield*/,
                    items.readItem(reader, mod, version, config),
                  ];
                case 1:
                  item = _a.sent();
                  return [
                    4 /*yield*/,
                    (0, attribute_enhancer_1.enhanceItems)(
                      [item],
                      mod,
                      version,
                    ),
          ...
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_s) {
              switch (_s.label) {
                ...
                case 1:
                  _b.apply(_a, [_s.sent()]);
                  constants = (0, constants_1.getConstantData)(
                    mod,
                    data.header.version,
                  );
                  ...
                  return [
                    4 /*yield*/,
                    (0, header_1.writeHeaderData)(data, constants),
                  ];
                case 2:
                  _d.apply(_c, [_s.sent()]);
                  ...
                  return [
                    4 /*yield*/,
                    (0, attributes_1.writeAttributes)(data, constants),
                  ];
                case 3:
                  _f.apply(_e, [_s.sent()]);
                ...
                case 4:
                  ...
                  return [
                    4 /*yield*/,
                    items.writeCharItems(data, mod, version, config),
                  ];
                case 5:
                  _k.apply(_j, [_s.sent()]);
                  ...
                  return [
                    4 /*yield*/,
                    items.writeCorpseItem(data, mod, version, config),
                  ];
                case 6:
                  _m.apply(_l, [_s.sent()]);
                  ...
                  return [
                    4 /*yield*/,
                    items.writeMercItems(data, mod, version, config),
                  ];
                case 7:
                  _p.apply(_o, [_s.sent()]);
                  ...
                  return [
                    4 /*yield*/,
                    items.writeGolemItems(data, mod, version, config),
                  ];
                case 8:
                  _r.apply(_q, [_s.sent()]);
                  _s.label = 9;
                case 9:
                  return [4 /*yield*/, (0, header_1.fixHeader)(writer)];
                case 10:
                  _s.sent();
                  return [2 /*return*/, writer.ToArray()];
              }
            ...
            return __generator(this, function (_c) {
              switch (_c.label) {
                case 0:
                  ...
                  return [
                    4 /*yield*/,
                    items.writeItem(item, mod, version, config),
                  ];
                case 1:
                  _b.apply(_a, [_c.sent()]);
                  return [2 /*return*/, writer.ToArray()];
  ...
  \**************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, "__esModule", { value: true });
        exports.fixHeader =
          exports.writeHeaderData =
          exports.writeHeader =
          exports.readHeaderData =
          exports.readHeader =
            void 0;
        var bitwriter_1 = __webpack_require__(
          /*! ../binary/bitwriter */ "./src/binary/bitwriter.ts",
        ...
        function readHeader(char, reader) {
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              char.header = {};
              //0x0000
              char.header.identifier = reader
                .ReadUInt32()
                .toString(16)
                .padStart(8, "0");
              if (char.header.identifier != "aa55aa55") {
                throw new Error(
                  "D2S identifier 'aa55aa55' not found at position ".concat(
                    reader.offset - 4 * 8,
                  ),
                );
              }
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  ...
                  return [
                    4 /*yield*/,
                    _versionSpecificHeader(char.header.version),
                  ];
                case 1:
                  v = _a.sent();
                  if (v == null) {
                    throw new Error(
                      "Cannot parse version: ".concat(char.header.version),
                    );
                  }
                ...
                case 1:
                  return [
                    ...
                    Promise.resolve().then(function () {
                      return __importStar(
                        __webpack_require__(
                          /*! ./versions/default_header */ "./src/d2/versions/default_header.ts",
                        ),
                      );
                    }),
                  ];
  ...
  \*************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        exports.types =
          exports.Quality =
          exports.ItemType =
          exports.setConstantData =
          exports.getConstantData =
          exports.enhancePlayerAttributes =
          exports.enhanceItems =
          exports.enhanceAttributes =
          exports.writeSkills =
          exports.readSkills =
          exports.writeAttributes =
          exports.readAttributes =
          exports.fixHeader =
          exports.writeHeaderData =
          exports.writeHeader =
          exports.readHeaderData =
          exports.readHeader =
            void 0;
        __exportStar(
          __webpack_require__(/*! ./d2s */ "./src/d2/d2s.ts"),
          exports,
        );
        var header_1 = __webpack_require__(
          /*! ./header */ "./src/d2/header.ts",
        ...
        Object.defineProperty(exports, "readHeader", {
          enumerable: true,
          get: function () {
            return header_1.readHeader;
          },
        });
        Object.defineProperty(exports, "readHeaderData", {
          enumerable: true,
          get: function () {
            return header_1.readHeaderData;
          },
        });
        Object.defineProperty(exports, "writeHeader", {
          enumerable: true,
          get: function () {
            return header_1.writeHeader;
          },
        });
        Object.defineProperty(exports, "writeHeaderData", {
          enumerable: true,
          get: function () {
            return header_1.writeHeaderData;
          },
        });
        Object.defineProperty(exports, "fixHeader", {
          enumerable: true,
          get: function () {
            return header_1.fixHeader;
          },
        });
        var attributes_1 = __webpack_require__(
          /*! ./attributes */ "./src/d2/attributes.ts",
        );
        Object.defineProperty(exports, "readAttributes", {
          enumerable: true,
          get: function () {
            return attributes_1.readAttributes;
          },
        });
        Object.defineProperty(exports, "writeAttributes", {
          enumerable: true,
          get: function () {
            return attributes_1.writeAttributes;
          },
        });
        var skills_1 = __webpack_require__(
          /*! ./skills */ "./src/d2/skills.ts",
        );
        Object.defineProperty(exports, "readSkills", {
          enumerable: true,
          get: function () {
            return skills_1.readSkills;
          },
        });
        Object.defineProperty(exports, "writeSkills", {
          enumerable: true,
          get: function () {
            return skills_1.writeSkills;
          },
        });
        var attribute_enhancer_1 = __webpack_require__(
          /*! ./attribute_enhancer */ "./src/d2/attribute_enhancer.ts",
        );
        Object.defineProperty(exports, "enhanceAttributes", {
          enumerable: true,
          get: function () {
            return attribute_enhancer_1.enhanceAttributes;
          },
        });
        Object.defineProperty(exports, "enhanceItems", {
          enumerable: true,
          get: function () {
            return attribute_enhancer_1.enhanceItems;
          },
        });
        Object.defineProperty(exports, "enhancePlayerAttributes", {
          enumerable: true,
          get: function () {
            return attribute_enhancer_1.enhancePlayerAttributes;
          },
        });
        var constants_1 = __webpack_require__(
          /*! ./constants */ "./src/d2/constants.ts",
        );
        Object.defineProperty(exports, "getConstantData", {
          enumerable: true,
          get: function () {
            return constants_1.getConstantData;
          },
        });
        Object.defineProperty(exports, "setConstantData", {
          enumerable: true,
          get: function () {
            return constants_1.setConstantData;
          },
        });
        ...
        Object.defineProperty(exports, "ItemType", {
          enumerable: true,
          get: function () {
            return items_1.ItemType;
          },
        });
        Object.defineProperty(exports, "Quality", {
          enumerable: true,
          get: function () {
            return items_1.Quality;
          },
        });
        exports.types = __importStar(
          __webpack_require__(/*! ./types */ "./src/d2/types.ts"),
        );
        __exportStar(
          __webpack_require__(/*! ./utils */ "./src/d2/utils.ts"),
          exports,
        );
  ...
  \*************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        exports._writeMagicProperties =
          ...
          exports.writeItems =
          exports.readItems =
          exports.writeCorpseItem =
          exports.readCorpseItems =
          exports.writeGolemItems =
          exports.readGolemItems =
          exports.writeMercItems =
          exports.readMercItems =
          exports.writeCharItems =
          exports.readCharItems =
          exports.Quality =
          exports.ItemType =
            void 0;
        var bitreader_1 = __webpack_require__(
    ...
    "Z": { "v": 17384, "l": 17 } /*00100001111101000*/
            ...
            return __generator(this, function (_b) {
              switch (_b.label) {
                case 0:
                  ...
                  return [
                    4 /*yield*/,
                    readItems(reader, mod, char.header.version, config, char),
                  ];
                case 1:
                  _a.items = _b.sent();
                  return [2 /*return*/];
            ...
            return __generator(this, function (_c) {
              switch (_c.label) {
                case 0:
                  ...
                  return [
                    4 /*yield*/,
                    writeItems(char.items, mod, version, config),
                  ];
                case 1:
                  _b.apply(_a, [_c.sent()]);
                  return [2 /*return*/, writer.ToArray()];
              ...
              switch (_b.label) {
                case 0:
                  ...
                  if (header !== "jf") {
                    ...
                    throw new Error(
                      "Mercenary header 'jf' not found at position ".concat(
                        reader.offset - 2 * 8,
                      ),
                    );
                  }
                  if (
                    !(
                      char.header.merc_id &&
                      parseInt(char.header.merc_id, 16) !== 0
                    )
                  )
                    return [3 /*break*/, 2];
                  _a = char;
            ...
            return __generator(this, function (_c) {
              switch (_c.label) {
                case 0:
                  ...
                  return [
                    4 /*yield*/,
                    writeItems(char.merc_items, mod, version, config),
                  ];
                case 1:
                  _b.apply(_a, [_c.sent()]);
                  _c.label = 2;
              ...
              switch (_b.label) {
                case 0:
                  ...
                  if (header !== "kf") {
                    ...
                    throw new Error(
                      "Golem header 'kf' not found at position ".concat(
                        reader.offset - 2 * 8,
                      ),
                    );
                  }
                  ...
                  return [
                    4 /*yield*/,
                    readItem(reader, mod, char.header.version, config),
                  ];
                case 1:
            ...
            return __generator(this, function (_c) {
              switch (_c.label) {
                case 0:
                  ...
                  return [
                    4 /*yield*/,
                    writeItem(char.golem_item, mod, version, config),
                  ];
                case 1:
                  _b.apply(_a, [_c.sent()]);
                  return [3 /*break*/, 3];
              ...
              switch (_d.label) {
                case 0:
                  ...
                  if (header !== "JM") {
                    ...
                    throw new Error(
                      "Corpse header 'JM' not found at position ".concat(
                        reader.offset - 2 * 8,
                      ),
                    );
                  }
            ...
            return __generator(this, function (_c) {
              switch (_c.label) {
                case 0:
                  ...
                  return [
                    4 /*yield*/,
                    writeItems(char.corpse_items, mod, version, config),
                  ];
                case 1:
                  _b.apply(_a, [_c.sent()]);
                  _c.label = 2;
              ...
              switch (_c.label) {
                case 0:
                  ...
                  if (header !== "JM") {
                    ...
                    throw new Error(
                      "Item list header 'JM' not found at position ".concat(
                        reader.offset - 2 * 8,
                      ),
                    );
                  }
            ...
            return __generator(this, function (_c) {
              switch (_c.label) {
                ...
                case 1:
                  ...
                  return [
                    4 /*yield*/,
                    writeItem(items[i], mod, version, config),
                  ];
                case 2:
                  _b.apply(_a, [_c.sent()]);
                  _c.label = 3;
              ...
              switch (_c.label) {
                case 0:
                  if (version <= 0x60) {
                    ...
                    if (header !== "JM") {
                      throw new Error(
                        "Item header 'JM' not found at position ".concat(
                          reader.offset - 2 * 8,
                        ),
                      );
                    }
                  ...
                  if (!item.simple_item) {
                    ...
                    switch (item.quality) {
                      ...
                      case Quality.Crafted:
                        ...
                        if (item.rare_name_id)
                          item.rare_name = constants.rare_names[
                            item.rare_name_id
                          ]
                        ...
                        if (item.rare_name_id2)
                          item.rare_name2 = constants.rare_names[
                            item.rare_name_id2
                          ]
                    ...
                    if (item.personalized) {
                      ...
                      item.personalized_name = new bitreader_1.BitReader(arr)
                        .ReadString(16)
                        .trim()
                        .replace(/\0/g, "");
                    }
                    ...
                    if (
                      ...
                      if (item.max_durability > 0) {
                        item.current_durability =
                          reader.ReadUInt16(
                            constants.magical_properties[72].sB,
                    ...
                    while (plist_flag > 0) {
                      if (plist_flag & 1) {
                        ...
                        magic_attributes = _readMagicProperties(
                          reader,
                          constants,
                        );
                  ...
                  reader.Align();
                  if (
                    !(item.nr_of_items_in_sockets > 0 && item.simple_item === 0)
                  )
                    return [3 /*break*/, 4];
                  item.socketed_items = [];
                  i = 0;
                  _c.label = 1;
                case 1:
                  if (!(i < item.nr_of_items_in_sockets))
                    return [3 /*break*/, 4];
              ...
              switch (_d.label) {
                case 0:
                  ...
                  if (item.categories === undefined) {
                    item.categories =
                      (_a = _GetItemTXT(item, constants)) === null ||
                      _a === void 0
                        ? void 0
                        : _a.c;
                  }
                  ...
                  if (!item.simple_item) {
                    ...
                    switch (item.quality) {
                      ...
                      case Quality.Crafted:
                        writer.WriteUInt8(
                          item.rare_name_id !== undefined
                            ? item.rare_name_id
                            : _lookupRareId(item.rare_name, constants),
                          8,
                        );
                        writer.WriteUInt8(
                          item.rare_name_id2 !== undefined
                            ? item.rare_name_id2
                            : _lookupRareId(item.rare_name2, constants),
                          8,
                        );
                        for (i = 0; i < 6; i++) {
                          magical_name_id =
                            item.magical_name_ids !== undefined
                              ? item.magical_name_ids[i]
                              : undefined;
                          if (magical_name_id) {
                            writer.WriteBit(1);
                    ...
                    if (
                      item.type_id === ItemType.Armor ||
                      item.type_id === ItemType.Shield
                    ) {
                      writer.WriteUInt16(
                        item.defense_rating +
                          constants.magical_properties[31].sA,
                        constants.magical_properties[31].sB,
                      );
                    }
                    if (
                      item.type_id === ItemType.Armor ||
                      ...
                      writer.WriteUInt16(
                        ...
                        constants.magical_properties[73].sB,
                      );
                      if (item.max_durability > 0) {
                        writer.WriteUInt16(
                          item.current_durability,
                    ...
                    if (item.quality === Quality.Set) {
                      set_attribute_count =
                        item.set_attributes != null
                          ? item.set_attributes.length
                          : 0;
                ...
                case 1:
                  ...
                  return [
                    4 /*yield*/,
                    writeItem(item.socketed_items[i], mod, version, config),
                  ];
                case 2:
                  _c.apply(_b, [_d.sent()]);
                  _d.label = 3;
        ...
        function _readSimpleBits(item, reader, version, constants, config) {
          ...
          if (item.is_ear) {
            ...
            var name_2 = new bitreader_1.BitReader(arr)
              .ReadString(15)
              .trim()
              .replace(/\0/g, "");
            item.ear_attributes = {
            ...
            if (version <= 0x60) {
              ...
              for (var i = 0; i < 4; i++) {
                ...
                do {
                  ...
                  if (node === undefined) {
                    console.log(
                      "Huffman value starting by " +
                        bits_1.split("").reverse().join("") +
                        "... is undefined.",
                    );
                  }
            ...
            item.categories =
              details === null || details === void 0 ? void 0 : details.c;
            if (
              item === null || item === void 0
                ? void 0
                : item.categories.includes("Any Armor")
            ) {
              item.type_id = ItemType.Armor;
            } else if (
              item === null || item === void 0
            ...
            if (
              (_a = item.categories) === null || _a === void 0
                ? void 0
                : _a.includes("Quest")
            ) {
        ...
        function _lookupRareId(name, constants) {
          ...
          return constants.rare_names.findIndex(function (k) {
            return (
              k &&
              k.n &&
        ...
        function _readMagicProperties(reader, constants) {
          ...
          while (id != 0x1ff) {
            ...
            if (!constants.magical_properties[id]) {
              throw new Error(
                "Invalid magic property Id: "
                  .concat(id, " at position ")
                  .concat(reader.offset - 9),
              );
            }
        ...
        function _writeMagicProperties(writer, properties, constants) {
          if (properties) {
            for (var i = 0; i < properties.length; i++) {
              ...
              var valueIdx = 0;
              writer.WriteUInt16(property.id, 9);
              var num_of_properties =
                constants.magical_properties[property.id].np || 1;
      ...
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        function readSkills(char, reader, mod) {
          ...
          if (header !== "if") {
            ...
            throw new Error(
              "Skills header 'if' not found at position ".concat(
                reader.offset - 2 * 8,
              ),
            );
          }
  ...
  \*************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        exports.nameRegex =
          /^[A-Za-z](?=.{0,14}$)[A-Za-z]*[A-Za-z\-_][A-Za-z]+$/;
  ...
  \*******************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function readHeader(char, reader, constants) {
          ...
          char.header.left_skill =
            (_a = constants.skills[reader.ReadUInt32()]) === null ||
            _a === void 0
              ? void 0
              : _a.s; //0x0078
          char.header.right_skill =
            (_b = constants.skills[reader.ReadUInt32()]) === null ||
            _b === void 0
              ? void 0
              : _b.s; //0x007c
          char.header.left_swap_skill =
            (_c = constants.skills[reader.ReadUInt32()]) === null ||
            _c === void 0
              ? void 0
              : _c.s; //0x0080
          char.header.right_swap_skill =
            (_d = constants.skills[reader.ReadUInt32()]) === null ||
            _d === void 0
              ? void 0
              : _d.s; //0x0084
        ...
        function writeHeader(char, writer, constants) {
          ...
          writer
            ...
            .WriteArray(
              _writeAssignedSkills(char.header.assigned_skills, constants),
            ) //0x0038
        ...
        function _classId(name, constants) {
          if (!name) return -1;
          return constants.classes.findIndex(function (c) {
            return c && c.n == name;
          });
        }
        function _skillId(name, constants) {
          ...
          if (name === "") return 0;
          if (!name) return -1;
          var idx = constants.skills.findIndex(function (s) {
            return s && s.s == name;
          });
          return idx >= 0 ? idx : 0;
        }
        ...
        function _writeCharMenuAppearance(appearance, constants) {
          ...
          var graphics = [];
          graphics.push(
            appearance && appearance.head ? appearance.head.graphic : 0,
          );
          graphics.push(
            appearance && appearance.torso ? appearance.torso.graphic : 0,
          );
          graphics.push(
            appearance && appearance.legs ? appearance.legs.graphic : 0,
          );
          graphics.push(
            appearance && appearance.right_arm
              ? appearance.right_arm.graphic
              : 0,
          );
          graphics.push(
          ...
          graphics.push(
            appearance && appearance.right_hand
              ? appearance.right_hand.graphic
              : 0,
          );
          graphics.push(
            appearance && appearance.left_hand
              ? appearance.left_hand.graphic
              : 0,
          );
          graphics.push(
          ...
          for (
            var _i = 0, graphics_1 = graphics;
            _i < graphics_1.length;
            _i++
          ) {
            var g = graphics_1[_i];
            writer.WriteUInt8(g);
          ...
          tints.push(
            appearance && appearance.torso ? appearance.torso.tint : 0,
          );
          ...
          tints.push(
            appearance && appearance.left_arm ? appearance.left_arm.tint : 0,
          );
          tints.push(
            appearance && appearance.right_hand
              ? appearance.right_hand.tint
              : 0,
          );
          tints.push(
          ...
          tints.push(
            appearance && appearance.shield ? appearance.shield.tint : 0,
          );
          tints.push(
            appearance && appearance.special1 ? appearance.special1.tint : 0,
          );
          tints.push(
            appearance && appearance.special2 ? appearance.special2.tint : 0,
          );
          tints.push(
            appearance && appearance.special3 ? appearance.special3.tint : 0,
          );
          tints.push(
            appearance && appearance.special4 ? appearance.special4.tint : 0,
          );
          tints.push(
            appearance && appearance.special5 ? appearance.special5.tint : 0,
          );
          tints.push(
            appearance && appearance.special6 ? appearance.special6.tint : 0,
          );
          tints.push(
            appearance && appearance.special7 ? appearance.special7.tint : 0,
          );
          tints.push(
            appearance && appearance.special8 ? appearance.special8.tint : 0,
          );
        ...
        function _readQuests(bytes) {
          ...
          quests.act_i.sisters_to_the_slaughter = _readQuest(
            reader.ReadArray(2),
          );
          ...
          quests.act_iii.blade_of_the_old_religion = _readQuest(
            reader.ReadArray(2),
          );
        ...
        function _writeQuests(quests) {
          ...
          writer.length = 96 * 8;
          var difficultyCompleted =
            +quests.act_v.completed ||
            +quests.act_v.eve_of_destruction.b0_is_completed;
          return writer
            ...
            .WriteUInt16(
              +quests.act_i.completed ||
                +quests.act_i.sisters_to_the_slaughter.b0_is_completed,
            )
            .WriteUInt16(
            ...
            .WriteUInt16(
              +quests.act_ii.completed ||
                +quests.act_ii.the_seven_tombs.b0_is_completed,
            )
            .WriteUInt16(
              +quests.act_iii.introduced ||
                +quests.act_ii.the_seven_tombs.b0_is_completed,
            )
            ...
            .WriteUInt16(
              +quests.act_iii.completed ||
                +quests.act_iii.the_guardian.b0_is_completed,
            )
            .WriteUInt16(
              +quests.act_iv.introduced ||
                +quests.act_iii.the_guardian.b0_is_completed,
            )
            ...
            .WriteUInt16(
              +quests.act_iv.completed ||
                +quests.act_iv.terrors_end.b0_is_completed,
            )
            .WriteArray(new Uint8Array(6))
            .WriteUInt16(
              +quests.act_v.introduced ||
                +quests.act_iv.terrors_end.b0_is_completed,
            )

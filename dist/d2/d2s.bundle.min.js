  ...
  var e = {
          ...
          return (
            ...
            (e.prototype.ReadByte = function (e) {
              return (
                void 0 === e && (e = 8),
                new DataView(
                  this.ReadBits(new Uint8Array(1), e).buffer,
                ).getUint8(0)
              );
            }),
            ...
            (e.prototype.ReadUInt16 = function (e) {
              return (
                void 0 === e && (e = 16),
                new DataView(
                  this.ReadBits(new Uint8Array(2), e).buffer,
                ).getUint16(0, this.littleEndian)
              );
            }),
            (e.prototype.ReadUInt32 = function (e) {
              return (
                void 0 === e && (e = 32),
                new DataView(
                  this.ReadBits(new Uint8Array(4), e).buffer,
        ...
        var r = (function () {
          ...
          return (
            ...
            (e.prototype.WriteByte = function (e, t) {
              ...
              return (
                new DataView(r.buffer).setUint8(0, e), this.WriteBytes(r, t)
              );
            }),
            ...
            (e.prototype.PeekBytes = function (e) {
              for (
                var t = new Uint8Array(e), r = 0, i = 0, a = 0;
                a < 8 * e;
                ++a
              )
      ...
      918: function (e, t, r) {
            ...
            function (e, t, r) {
              if (r || 2 === arguments.length)
                for (var i, a = 0, n = t.length; a < n; a++)
                  (!i && a in t) ||
                    (i || (i = Array.prototype.slice.call(t, 0, a)),
                    (i[a] = t[a]));
        ...
        function c(e, t, r, i) {
          ...
          (e.item_bonuses = [].concat
            ...
            (e.item_bonuses = v(e.item_bonuses, a)),
            _(e.item_bonuses, a, e.attributes.level, i);
        }
        function l(e, t, r, i, a, n) {
          if ((void 0 === i && (i = 1), e))
        ...
        function u(e, t, r, i, a, c) {
          var l, u, f, m;
          void 0 === i && (i = 1);
          var y = (0, s.getConstantData)(t, r);
          if (c) {
            var g =
                y.armor_items[c.type] ||
                y.weapon_items[c.type] ||
                y.other_items[c.type],
              b = y.other_items[e.type];
            b.m &&
              (e.magic_attributes = (function (e, t) {
                for (var r = [], i = 0, a = e; i < a.length; i++)
                  for (
                    ...
                    u.np && (o += u.np);
                    var _ = [n.min, n.max];
                    n.p && _.push(n.p), r.push({ id: d, values: _, name: u.s });
                  }
                return r;
              })(b.m[g.gt], y));
          }
          e.level = d(e.level, 1, 99);
          var w = null;
          if (y.armor_items[e.type])
            (w = y.armor_items[e.type]),
              (e.type_id = n.Armor),
              w.maxac &&
                (0 == e.ethereal
                  ? (e.defense_rating = w.maxac)
                  : 1 == e.ethereal &&
                    (e.defense_rating = Math.floor(1.5 * w.maxac)));
          else if (y.weapon_items[e.type]) {
            (w = y.weapon_items[e.type]), (e.type_id = n.Weapon);
            var W = {};
            0 == e.ethereal
              ? (w.mind && (W.mindam = w.mind),
                w.maxd && (W.maxdam = w.maxd),
                w.min2d && (W.twohandmindam = w.min2d),
                w.max2d && (W.twohandmaxdam = w.max2d))
              : 1 == e.ethereal &&
                (w.mind && (W.mindam = Math.floor(1.5 * w.mind)),
                w.maxd && (W.maxdam = Math.floor(1.5 * w.maxd)),
                w.min2d && (W.twohandmindam = Math.floor(1.5 * w.min2d)),
                w.max2d && (W.twohandmaxdam = Math.floor(1.5 * w.max2d))),
              (e.base_damage = W);
          } else
            y.other_items[e.type] &&
              ((e.type_id = n.Other), (w = y.other_items[e.type]));
          if (w)
            if (
              (w.n && (e.type_name = w.n),
              w.rs && (e.reqstr = w.rs),
              w.rd && (e.reqdex = w.rd),
              w.i && (e.inv_file = w.i),
              w.hdi && (e.hd_inv_file = w.hdi),
              w.ih && (e.inv_height = w.ih),
              w.iw && (e.inv_width = w.iw),
              w.it && (e.inv_transform = w.it),
              w.iq && (e.item_quality = w.iq),
              w.c && (e.categories = w.c),
              w.durability &&
                (0 == e.ethereal
                  ? ((e.current_durability = w.durability),
                    (e.max_durability = w.durability))
                  : 1 == e.ethereal &&
                    ((e.current_durability =
                      w.durability - Math.ceil(w.durability / 2) + 1),
                    (e.max_durability =
                      w.durability - Math.ceil(w.durability / 2) + 1))),
              (e.total_nr_of_sockets = d(
                e.total_nr_of_sockets,
                0,
                w.gs || e.inv_width * e.inv_height,
              )),
              e.total_nr_of_sockets > 0 ? (e.socketed = 1) : (e.socketed = 0),
              e.personalized_name && e.personalized_name.length
                ? o.nameRegex.test(e.personalized_name)
                  ? (e.personalized = 1)
                  : ((e.personalized_name = ""), (e.personalized = 0))
                : (e.personalized = 0),
              w.ig && w.ig.length && !e.multiple_pictures
                ? ((e.multiple_pictures = 1), (e.picture_id = 0))
                : !w.ig &&
                  e.multiple_pictures &&
                  ((e.multiple_pictures = 0), (e.picture_id = 0)),
              e.multiple_pictures &&
                w.ig &&
                w.ig.length &&
                w.ig[e.picture_id] &&
                (e.inv_file = w.ig[e.picture_id]),
              e.multiple_pictures &&
                w.hdig &&
                w.hdig.length &&
                w.hdig[e.picture_id] &&
                (e.hd_inv_file = w.hdig[e.picture_id]),
              e.magic_prefix || e.magic_suffix)
            )
              e.magic_prefix &&
                (null === (l = y.magic_prefixes[e.magic_prefix]) || void 0 === l
                  ? void 0
                  : l.tc) &&
                (e.transform_color = y.magic_prefixes[e.magic_prefix].tc),
                e.magic_suffix &&
                  (null === (u = y.magic_suffixes[e.magic_suffix]) ||
                  void 0 === u
                    ? void 0
                    : u.tc) &&
                  (e.transform_color = y.magic_suffixes[e.magic_suffix].tc);
            else if (e.magical_name_ids && 6 === e.magical_name_ids.length)
              for (var B = 0; B < 6; B++) {
                var k = e.magical_name_ids[B];
                k &&
                  (B % 2 == 0 &&
                  y.magic_prefixes[k] &&
                  (null === (f = y.magic_prefixes[k]) || void 0 === f
                    ? void 0
                    : f.tc)
                    ? (e.transform_color = y.magic_prefixes[k].tc)
                    : y.magic_suffixes[k] &&
                      (null === (m = y.magic_suffixes[k]) || void 0 === m
                        ? void 0
                        : m.tc) &&
                      (e.transform_color = y.magic_suffixes[k].tc));
              }
            else if (e.unique_id) {
              var A = y.unq_items[e.unique_id];
              w.ui && (e.inv_file = w.ui),
                A && A.i && (e.inv_file = A.i),
                A && A.hdi && (e.hd_inv_file = A.hdi),
                A && A.tc && (e.transform_color = A.tc);
            } else if (e.set_id) {
              var I = y.set_items[e.set_id];
              w.ui && (e.inv_file = w.ui),
                I && I.i && (e.inv_file = I.i),
                I && I.hdi && (e.hd_inv_file = I.hdi),
                I && I.tc && (e.transform_color = I.tc);
            }
          (e.magic_attributes || e.runeword_attributes || e.socketed_items) &&
            ((e.displayed_magic_attributes = _(e.magic_attributes, y, i, a)),
            (e.displayed_runeword_attributes = _(
              e.runeword_attributes,
              y,
              i,
              a,
            )),
            (e.combined_magic_attributes = v(p(e), y)),
            (e.displayed_combined_magic_attributes = _(
        ...
        function _(e, t, r, n) {
          ...
          for (
            var p = function (e) {
                ...
                if (null == i)
                  throw new Error(
                    "Cannot find Magical Property for id: ".concat(e.id),
                  );
                ...
                if (
                  (i.dg &&
                    4 === o[i.dg - 1] &&
                    ((s =
                      (a = c[i.dg - 1]) >= 0 ? i.dgP : i.dgN ? i.dgN : i.dgP),
                    (l = i.dgV),
                    (n = i.dgF),
                    (d = i.dg2)),
                  i.np)
                  ...
                  e.values[0] === e.values[1] &&
                    ...
                    "item_maxdamage_percent" === i.s &&
                      (s = "+%d% ".concat(
                        s.replace(/}/gi, "").replace(/%\+?d%%/gi, ""),
                      ))),
                    (e.description = s.replace(/%d/gi, function () {
                      return e.values[u++];
                    }));
                } else
                  !(function (e, t, r, i, a, n, s) {
                    if (i) {
                      ...
                      switch (i) {
                        ...
                        case 14:
                          (n = f(
                            (d = t.classes[e.values[1]]).ts[e.values[0]],
                            r,
                          )),
                            (e.description = "".concat(n, " ").concat(d.co));
                          break;
                        case 15:
                          var u = e.values[1],
                            _ = (v = t.skills[u])
                              ? v.s
                              : "Unknown_Skill_".concat(u);
                          (n = f(n, e.values[2], e.values[0], _)),
                            (e.description = "".concat(n));
                          break;
                        case 16:
                          (u = e.values[0]),
                            (_ = (v = t.skills[u])
                            ...
                            (e.description = e.description.replace(/%s/, _));
                          break;
                        case 17:
                          e.description = ""
                            .concat(r, " ")
                            .concat(n, " (Increases near [time])");
                          break;
                        case 18:
                          e.description = ""
                            .concat(r, "% ")
                        ...
                        default:
                          throw new Error(
                            "No handler for descFunc: ".concat(i),
                          );
                      }
                      if (c)
                        switch ((a = a || 0)) {
                          case 0:
                            ...
                            break;
                          case 1:
                            e.description = "".concat(c, " ").concat(n);
                            break;
                          case 2:
                            e.description = "".concat(n, " ").concat(c);
                            break;
                          default:
                            throw new Error(
                              "No handler for descVal: ".concat(a),
                            );
                        }
                      l && (e.description += " ".concat(s));
                    }
                  })(e, t, a, n, l, s, d);
              },
              v = 0,
            ...
            p((u = m[v]));
          (null == n ? void 0 : n.sortProperties) &&
            s.sort(function (e, r) {
              return (
                t.magical_properties[r.id].so - t.magical_properties[e.id].so
              );
            });
          for (var y = s.length - 1; y >= 1; y--)
            for (var g = y - 1; g >= 0; g--)
              s[y].description === s[g].description && (s[g].visible = !1);
          return s;
        }
        function f(e) {
        ...
        function p(e, t) {
          var r = [];
          if (e.socketed_items)
            for (var i = 0, n = e.socketed_items; i < n.length; i++) {
              var s = n[i];
              s.magic_attributes &&
                (r = r.concat.apply(
                  r,
                  JSON.parse(JSON.stringify(s.magic_attributes)),
                ));
            }
          var o = e.magic_attributes || [],
            c = e.runeword_attributes || [];
          return a(
            a(
              a(a([], [], !1), JSON.parse(JSON.stringify(o)), !0),
              ...
              i = function (e) {
                ...
                if (a && a.length)
                  for (var n = 0; n < a.length; n++) {
                    var s = a[n];
                    if (i.np) {
                      (s.values[0] += e.values[0]),
                        (s.values[1] += e.values[1]);
                      break;
                    }
                    for (
                      var o = !0, c = 3 === i.e ? 2 : 1, l = 0;
                      l < s.values.length - c &&
                      (o = s.values[l] === e.values[l]);
                      l++
                    );
                    if (o)
                      for (l = 1; l <= c; l++) {
        ...
        !(function (e) {
          ...
          (t.enhanceAttributes = function (e, t, r, i) {
            l(e.items, t, r, e.attributes.level, i),
              l([e.golem_item], t, r, e.attributes.level, i),
              l(e.merc_items, t, r, e.attributes.level, i),
              l(e.corpse_items, t, r, e.attributes.level, i),
              c(e, t, r, i);
          }),
      ...
      926: function (e, t, r) {
                        ...
                        switch (
                          ...
                          default:
                            if (
                              !(
                                (a =
                                  (a = s.trys).length > 0 && a[a.length - 1]) ||
                                (6 !== o[0] && 2 !== o[0])
                              )
                            ) {
                              s = 0;
        ...
        (t.readAttributes = function (e, t, r) {
          var i = (0, s.getConstantData)(r, e.header.version),
            a = i.magical_properties.filter(function (e, t) {
              return e && e.c && t < 256;
            });
          if (
            ((e.attributes = a.reduce(function (e, t) {
              return (e[t.s] = 0), e;
            }, {})),
            "gf" != t.ReadString(2))
          ) {
            if (1 === e.header.level) {
              var n = i.classes.find(function (t) {
                return t.n === e.header.class;
              }).a;
              return void (e.attributes = {
                strength: +n.str,
                energy: +n.int,
                dexterity: +n.dex,
                vitality: +n.vit,
          ...
          for (var o = t.ReadUInt16(9); 511 != o; ) {
            var c = i.magical_properties[o];
            if (void 0 === c)
              throw new Error("Invalid attribute id: ".concat(o));
            var l = c.cB;
            if (void 0 === l)
              throw new Error("Missing CSV save bits for id: ".concat(o));
            (e.attributes[c.s] = t.ReadUInt32(l)),
              c.cVS && (e.attributes[c.s] >>>= c.cVS),
              (o = t.ReadUInt16(9));
          }
          t.Align();
        }),
          (t.writeAttributes = function (e, t) {
            return i(this, void 0, void 0, function () {
              ...
              return a(this, function (a) {
                for (
                  (r = new n.BitWriter()).WriteString("gf", 2),
                    i = t.magical_properties.filter(function (e, t) {
                      return e && e.c && t < 256;
                    }),
                    s = 0,
                    o = i;
                  ...
                  if (((c = o[s]), (l = e.attributes[c.s]))) {
                    if (void 0 === (d = c.cB))
                      throw new Error(
                        "Missing CSV save bits for attribute: ".concat(c),
                      );
                    c.cVS && (l <<= c.cVS),
                      r.WriteUInt16(c.id, 9),
                      r.WriteUInt32(l, d);
                  }
      ...
      184: (e, t) => {
        ...
        var r = { vanilla: {}, remodded: {} };
        (t.getConstantData = function (e, t) {
          if (!(e in r))
            throw new Error(
              "No constant data found for this mod "
                .concat(e, ". Supported mods are: ")
                .concat(Object.keys(r).join(", ")),
            );
          if (!(t.toString() in r[e]))
            throw new Error(
              "No constant data found for version "
                .concat(t, " of mod ")
                .concat(e, ". Supported versions are: ")
                .concat(Object.keys(r[e]).join(", ")),
            );
          return r[e][t.toString()];
        }),
          (t.setConstantData = function (e, t, i) {
            r[e][t.toString()] = i;
          });
      },
      758: function (e, t, r) {
        ...
        (t.reader = function (e) {
                ...
                switch (s.label) {
                  case 0:
                    return (
                      ...
                      (a = new d.BitReader(e)),
                      (n = Object.assign(v, r)),
                      [4, (0, c.readHeader)(i, a)]
                    );
                  case 1:
                    return s.sent(), [4, (0, c.readHeaderData)(i, a, t)];
                  case 2:
                    return s.sent(), [4, (0, l.readAttributes)(i, a, t)];
                  case 3:
                    return s.sent(), [4, (0, _.readSkills)(i, a, t)];
                  case 4:
                    return s.sent(), [4, f.readCharItems(i, a, t, n)];
                  case 5:
                    return s.sent(), [4, f.readCorpseItems(i, a, t, n)];
                  case 6:
                    return (
                      s.sent(),
                      i.header.status.expansion
                        ? [4, f.readMercItems(i, a, t, n)]
                        : [3, 9]
                    );
                  case 7:
                    return s.sent(), [4, f.readGolemItems(i, a, t, n)];
                  case 8:
                    s.sent(), (s.label = 9);
                  case 9:
                    return [
                      4,
                      (0, p.enhanceAttributes)(i, t, i.header.version, n),
                    ];
                  case 10:
                    return s.sent(), [2, i];
                }
                ...
                switch (o.label) {
                  case 0:
                    return (
                      (a = new d.BitReader(e)),
                      (n = Object.assign(v, i)),
                      [4, f.readItem(a, t, r, n)]
                    );
                  case 1:
                    return (s = o.sent()), [4, (0, p.enhanceItems)([s], t, r)];
                  case 2:
                    return o.sent(), [2, s];
                }
              });
          ...
          (t.write = function (e, t, r, i) {
            return s(this, void 0, void 0, function () {
              var a, n, s, d, p, m, y, g, b, w, W, B, k, A, I, U, R, S, x;
              return o(this, function (o) {
                switch (o.label) {
                  case 0:
                    return (
                  ...
                  case 1:
                    return (
                      d.apply(s, [o.sent()]),
                      (p = (0, h.getConstantData)(t, e.header.version)),
                      (y = (m = n).WriteArray),
                      [4, (0, c.writeHeaderData)(e, p)]
                    );
                  case 2:
                    return (
                      y.apply(m, [o.sent()]),
                      (b = (g = n).WriteArray),
                      [4, (0, l.writeAttributes)(e, p)]
                    );
                  case 3:
                    return (
                      b.apply(g, [o.sent()]),
                  ...
                  case 4:
                    return (
                      W.apply(w, [o.sent()]),
                      (k = (B = n).WriteArray),
                      [4, f.writeCharItems(e, t, r, a)]
                    );
                  case 5:
                    return (
                      k.apply(B, [o.sent()]),
                      (I = (A = n).WriteArray),
                      [4, f.writeCorpseItem(e, t, r, a)]
                    );
                  case 6:
                    return (
                      I.apply(A, [o.sent()]),
                  ...
                  case 7:
                    return (
                      R.apply(U, [o.sent()]),
                      (x = (S = n).WriteArray),
                      [4, f.writeGolemItems(e, t, r, a)]
                    );
                  case 8:
                    x.apply(S, [o.sent()]), (o.label = 9);
                  case 9:
                    return [4, (0, c.fixHeader)(n)];
                  case 10:
                    return o.sent(), [2, n.ToArray()];
                }
              });
            });
          }),
            ...
            return s(this, void 0, void 0, function () {
              ...
              return o(this, function (n) {
                switch (n.label) {
                  case 0:
                    return (
                      (i = (0, l.getConstantData)(r, e.header.version)),
                      [4, d(e.header.version)]
                    );
                  case 1:
                    if (null == (a = n.sent()))
                      throw new Error(
                        "Cannot parse version: ".concat(e.header.version),
                      );
                    return a.readHeader(e, t, i), [2];
                }
              });
            });
          }),
          ...
          (t.writeHeaderData = function (e, t) {
            return s(this, void 0, void 0, function () {
              ...
              return o(this, function (a) {
                switch (a.label) {
                  case 0:
                    return (r = new c.BitWriter()), [4, d(e.header.version)];
                  case 1:
                    if (null == (i = a.sent()))
                      throw new Error(
                        "Cannot parse version: ".concat(e.header.version),
      ...
      814: function (e, t, r) {
              ...
              switch (a.label) {
                case 0:
                  if (((i = []), "JM" !== e.ReadString(2))) {
                    if (1 === (null == s ? void 0 : s.header.level))
                      return [2, []];
                    throw new Error(
          ...
          return i(this, void 0, void 0, function () {
            ...
            return a(this, function (a) {
              switch (a.label) {
                ...
                case 1:
                  return s < e.length
                    ? ((l = (o = i).WriteArray), [4, p(e[s], t, r, n)])
                    : [3, 4];
                case 2:
        ...
        function h(e, t, r, c) {
          return i(this, void 0, void 0, function () {
            var i, u, _, f, p, v, y, b, w;
            return a(this, function (a) {
              switch (a.label) {
                case 0:
                  if (r <= 96 && "JM" !== e.ReadString(2))
                    throw new Error(
                  ...
                  if (
                    ...
                    (function (e, t, r, i, a) {
                      ...
                      if (
                        ...
                        r <= 96
                          ...
                          : r >= 97 &&
                            (e.version = t.ReadUInt16(3).toString(2)),
                        ...
                        for (
                          var c = t.ReadUInt8(3),
                            ...
                            u = new Uint8Array(15),
                            _ = 0;
                          _ < u.length && ((u[_] = t.ReadUInt8(7)), 0 !== u[_]);
                          _++
                        );
                        var f = new o.BitReader(u)
                          .ReadString(15)
                          .trim()
                          .replace(/\0/g, "");
                        e.ear_attributes = { class: c, level: l, name: f };
                      } else {
                        if (r <= 96) e.type = t.ReadString(4);
                        else if (r >= 97)
                          for (e.type = "", _ = 0; _ < 4; _++) {
                            var h = d,
                              p = "";
                            do {
                              var v = t.ReadBit();
                        ...
                        var m = g(e, i);
                        (e.categories = null == m ? void 0 : m.c),
                          (
                            null == e
                              ? void 0
                              : e.categories.includes("Any Armor")
                          )
                            ? (e.type_id = n.Armor)
                            : (
                                  null == e
                                    ? void 0
                                    : e.categories.includes("Weapon")
                                )
                              ? ((e.type_id = n.Weapon),
                                (m = i.weapon_items[e.type]))
                              : (e.type_id = n.Other);
                        var y = e.simple_item ? 1 : 3;
                        (null === (s = e.categories) || void 0 === s
                          ...
                          (y = 1)),
                          (e.nr_of_items_in_sockets = t.ReadUInt8(y));
                      }
                    })(
                      (u = {
                        identified: 0,
                    ...
                    switch (
                      ((u.id = e.ReadUInt32(32)),
                      (u.level = e.ReadUInt8(7)),
                      (u.quality = e.ReadUInt8(4)),
                      (u.multiple_pictures = e.ReadBit()),
                      u.multiple_pictures && (u.picture_id = e.ReadUInt8(3)),
                      (u.class_specific = e.ReadBit()),
                      u.class_specific && (u.auto_affix_id = e.ReadUInt16(11)),
                      u.quality)
                    ) {
                      case s.Low:
                        u.low_quality_id = e.ReadUInt8(3);
                        break;
                      case s.Normal:
                        break;
                      case s.Superior:
                        u.file_index = e.ReadUInt8(3);
                        break;
                      case s.Magic:
                        (u.magic_prefix = e.ReadUInt16(11)),
                          (u.magic_suffix = e.ReadUInt16(11));
                        break;
                      case s.Set:
                        (u.set_id = e.ReadUInt16(12)),
                          (u.set_name = i.set_items[u.set_id]
                            ? i.set_items[u.set_id].n
                            : null);
                        break;
                      case s.Unique:
                        (u.unique_id = e.ReadUInt16(12)),
                          (u.unique_name = i.unq_items[u.unique_id]
                            ? i.unq_items[u.unique_id].n
                            : null);
                        break;
                      case s.Rare:
                      case s.Crafted:
                        for (
                          u.rare_name_id = e.ReadUInt8(8),
                            u.rare_name_id &&
                              (u.rare_name = i.rare_names[u.rare_name_id]
                                ? i.rare_names[u.rare_name_id].n
                                : null),
                            u.rare_name_id2 = e.ReadUInt8(8),
                            u.rare_name_id2 &&
                              (u.rare_name2 = i.rare_names[u.rare_name_id2]
                                ? i.rare_names[u.rare_name_id2].n
                                : null),
                            u.magical_name_ids = [],
                            y = 0;
                          y < 6;
                          ...
                          (_ = e.ReadBit()),
                            (u.magical_name_ids[y] =
                              1 === _ ? e.ReadUInt16(11) : null);
                    }
                    if (
                      (u.given_runeword &&
                        ((u.runeword_id = e.ReadUInt16(12)),
                        2718 == u.runeword_id && (u.runeword_id = 48),
                        i.runewords[u.runeword_id] &&
                          (u.runeword_name = i.runewords[u.runeword_id].n),
                        e.ReadUInt8(4)),
                      u.personalized)
                    ) {
                      for (
                        f = new Uint8Array(16), y = 0;
                        y < f.length &&
                        ((f[y] = r > 97 ? e.ReadUInt8(8) : e.ReadUInt8(7)),
                        0 !== f[y]);
                        y++
                      );
                      u.personalized_name = new o.BitReader(f)
                        .ReadString(16)
                        .trim()
                        .replace(/\0/g, "");
                    }
                    for (
                      ("tbk" !== u.type && "ibk" != u.type) || e.ReadUInt8(5),
                        u.timestamp = e.ReadUInt8(1),
                        u.type_id === n.Armor &&
                          (u.defense_rating =
                            e.ReadUInt16(i.magical_properties[31].sB) -
                            i.magical_properties[31].sA),
                        (u.type_id !== n.Armor && u.type_id !== n.Weapon) ||
                          ((u.max_durability =
                            e.ReadUInt16(i.magical_properties[73].sB) -
                            i.magical_properties[73].sA),
                          u.max_durability > 0 &&
                            (u.current_durability =
                              e.ReadUInt16(i.magical_properties[72].sB) -
                              i.magical_properties[72].sA)),
                        i.stackables[u.type] && (u.quantity = e.ReadUInt16(9)),
                        1 === u.socketed
                          ? (u.total_nr_of_sockets = e.ReadUInt8(4))
                          : (u.total_nr_of_sockets = 0),
                        p = 0,
                        u.quality === s.Set &&
                          ((p = e.ReadUInt8(5)),
                          (u.set_list_count = 0),
                          (u._unknown_data.plist_flag = p)),
                        v = m(e, i),
                        u.magic_attributes = v;
                      p > 0;
                      ...
                      1 & p &&
                        ...
                        (v = m(e, i)),
                        u.set_attributes
                          ? u.set_attributes.push(v)
                          : (u.set_attributes = [v])),
                        (p >>>= 1);
                    1 === u.given_runeword &&
                      (v = m(e, i)) &&
                      v.length > 0 &&
                      (u.runeword_attributes = v);
                  }
                  if (
                    (e.Align(),
                    !(u.nr_of_items_in_sockets > 0 && 0 === u.simple_item))
                  )
                    return [3, 4];
                  (u.socketed_items = []), (y = 0), (a.label = 1);
                case 1:
                  return y < u.nr_of_items_in_sockets
                    ? ((w = (b = u.socketed_items).push), [4, h(e, t, r, c)])
                    : [3, 4];
                case 2:
                  w.apply(b, [a.sent()]), (a.label = 3);
                case 3:
                  return y++, [3, 1];
                case 4:
                  return [2, u];
              ...
              switch (a.label) {
                case 0:
                  if (
                    ...
                    void 0 === e.categories &&
                      (e.categories =
                        null === (d = g(e, i)) || void 0 === d ? void 0 : d.c),
                    (_ = new c.BitWriter()),
                    r <= 96 && _.WriteString("JM", 2),
                    (function (e, t, r, i) {
                      var a,
                        n = (0, l.getConstantData)(t, r);
                      e.WriteBits(i._unknown_data.b0_3 || new Uint8Array(4), 4),
                        e.WriteBit(i.identified),
                        e.WriteBits(
                          i._unknown_data.b5_10 || new Uint8Array(6),
                          6,
                        ),
                        e.WriteBit(i.socketed),
                        e.WriteBits(
                          i._unknown_data.b12 || new Uint8Array(1),
                          1,
                        ),
                        e.WriteBit(i.new),
                        e.WriteBits(
                          i._unknown_data.b14_15 || new Uint8Array(2),
                          2,
                        ),
                        e.WriteBit(i.is_ear),
                        e.WriteBit(i.starter_item),
                        e.WriteBits(
                          i._unknown_data.b18_20 || new Uint8Array(3),
                          3,
                        ),
                        e.WriteBit(i.simple_item),
                        e.WriteBit(i.ethereal),
                        e.WriteBits(
                          i._unknown_data.b23 || new Uint8Array([1]),
                          1,
                        ),
                        e.WriteBit(i.personalized),
                        e.WriteBits(
                          i._unknown_data.b25 || new Uint8Array(1),
                          1,
                        ),
                        e.WriteBit(i.given_runeword),
                        e.WriteBits(
                          i._unknown_data.b27_31 || new Uint8Array(5),
                          5,
                        );
                      var s = null != i.version ? i.version : "101";
                      if (
                        (r <= 96
                          ? e.WriteUInt16(parseInt(s, 10), 10)
                          : r >= 97 && e.WriteUInt16(parseInt(s, 2), 3),
                        e.WriteUInt8(i.location_id, 3),
                        e.WriteUInt8(i.equipped_id, 4),
                        e.WriteUInt8(i.position_x, 4),
                        e.WriteUInt8(i.position_y, 4),
                        e.WriteUInt8(i.alt_position_id, 3),
                        i.is_ear)
                      ) {
                        e.WriteUInt8(i.ear_attributes.class, 3),
                          e.WriteUInt8(i.ear_attributes.level, 7);
                        for (
                          var o = i.ear_attributes.name.substring(0, 15), c = 0;
                          c < o.length;
                          c++
                        )
                        ...
                        var d = i.type.padEnd(4, " ");
                        if (r <= 96) e.WriteString(d, 4);
                        else
                          for (var _ = 0, f = d; _ < f.length; _++) {
                            var h = f[_],
                              p = u[h];
                            e.WriteUInt32(p.v, p.l);
                          }
                        var v = i.simple_item ? 1 : 3;
                        if (
                          null === (a = i.categories) || void 0 === a
                            ? void 0
                            : a.includes("Quest")
                        ) {
                          var m = i.quest_difficulty || 0;
                          e.WriteUInt16(
                            m + n.magical_properties[356].sA,
                            n.magical_properties[356].sB,
                          ),
                            (v = 1);
                        }
                        e.WriteUInt8(i.nr_of_items_in_sockets, v);
                      }
                    })(_, t, r, e),
                    !e.simple_item)
                  ) {
                    switch (
                      (_.WriteUInt32(e.id, 32),
                      _.WriteUInt8(e.level, 7),
                      _.WriteUInt8(e.quality, 4),
                      _.WriteUInt8(e.multiple_pictures, 1),
                      e.multiple_pictures && _.WriteUInt8(e.picture_id, 3),
                      _.WriteUInt8(e.class_specific, 1),
                      1 === e.class_specific &&
                        _.WriteUInt16(e.auto_affix_id || 0, 11),
                      e.quality)
                    ) {
                      case s.Low:
                        _.WriteUInt8(e.low_quality_id, 3);
                        break;
                      case s.Normal:
                        break;
                      case s.Superior:
                        _.WriteUInt8(e.file_index || 0, 3);
                        break;
                      case s.Magic:
                        _.WriteUInt16(e.magic_prefix, 11),
                          _.WriteUInt16(e.magic_suffix, 11);
                        break;
                      case s.Set:
                        _.WriteUInt16(e.set_id, 12);
                        break;
                      case s.Unique:
                        _.WriteUInt16(e.unique_id, 12);
                        break;
                      case s.Rare:
                      case s.Crafted:
                        for (
                          ...
                          (f =
                            void 0 !== e.magical_name_ids
                              ? e.magical_name_ids[W]
                              : void 0)
                            ? (_.WriteBit(1), _.WriteUInt16(f, 11))
                            : _.WriteBit(0);
                    }
                    if (
                      (e.given_runeword &&
                        (2718 == (h = e.runeword_id) && (h = 48),
                        _.WriteUInt16(h, 12),
                        _.WriteUInt8(5, 4)),
                      e.personalized)
                    ) {
                      for (
                        m = e.personalized_name.substring(0, 16), W = 0;
                        W < m.length;
                        W++
                      )
                        r > 97
                          ? _.WriteUInt8(m.charCodeAt(W), 8)
                          : _.WriteUInt8(127 & m.charCodeAt(W), 7);
                      _.WriteUInt8(0, r > 97 ? 8 : 7);
                    }
                    if (
                      ("tbk" === e.type
                        ? _.WriteUInt8(0, 5)
                        : "ibk" === e.type && _.WriteUInt8(1, 5),
                      _.WriteUInt8(e.timestamp, 1),
                      (e.type_id !== n.Armor && e.type_id !== n.Shield) ||
                        _.WriteUInt16(
                          e.defense_rating + i.magical_properties[31].sA,
                          i.magical_properties[31].sB,
                        ),
                      (e.type_id !== n.Armor &&
                        e.type_id !== n.Shield &&
                        e.type_id !== n.Weapon) ||
                        (_.WriteUInt16(
                          e.max_durability || 0,
                          i.magical_properties[73].sB,
                        ),
                        e.max_durability > 0 &&
                          _.WriteUInt16(
                            e.current_durability,
                            i.magical_properties[72].sB,
                          )),
                      i.stackables[e.type] && _.WriteUInt16(e.quantity, 9),
                      1 === e.socketed &&
                        _.WriteUInt8(e.total_nr_of_sockets, 4),
                      e.quality === s.Set &&
                        ((b =
                          null != e.set_attributes
                            ? e.set_attributes.length
                            : 0),
                        (w = (1 << b) - 1),
                        _.WriteUInt8(e._unknown_data.plist_flag || w, 5)),
                      y(_, e.magic_attributes, i),
                      e.set_attributes && e.set_attributes.length > 0)
                    )
                      for (W = 0; W < e.set_attributes.length; W++)
                        y(_, e.set_attributes[W], i);
                    1 === e.given_runeword && y(_, e.runeword_attributes, i);
                  }
                  if (
                    (_.Align(),
                  ...
                  (W = 0), (a.label = 1);
                case 1:
                  return W < e.nr_of_items_in_sockets
                    ? ((k = (B = _).WriteArray),
                      [4, p(e.socketed_items[W], t, r, o)])
                    : [3, 4];
                case 2:
                  k.apply(B, [a.sent()]), (a.label = 3);
                case 3:
                  return W++, [3, 1];
                case 4:
                  return [2, _.ToArray()];
        ...
        function m(e, t) {
          for (var r = e.ReadUInt16(9), i = []; 511 != r; ) {
            var a = [];
            if (!t.magical_properties[r])
              throw new Error(
                "Invalid magic property Id: "
                  .concat(r, " at position ")
                  .concat(e.offset - 9),
              );
            for (var n = t.magical_properties[r].np || 1, s = 0; s < n; s++) {
              ...
              if (o.sP) {
                var c = e.ReadUInt32(o.sP);
                switch (
                  (14 === o.dF && (a.push(7 & c), (c = (c >> 3) & 8191)), o.e)
                ) {
                  case 1:
                  default:
                    break;
              ...
              if (!o.sB)
                throw new Error(
                  "Save Bits is undefined for stat: "
                    .concat(r, ":")
                    .concat(o.s, " at position ")
                    .concat(e.offset),
                );
              var l = e.ReadUInt32(o.sB);
              o.sA && (l -= o.sA),
                3 === o.e
        ...
        function y(e, t, r) {
          if (t)
            for (var i = 0; i < t.length; i++) {
              ...
              for (
                var s = r.magical_properties[a.id].np || 1, o = 0;
                o < s;
                o++
              ) {
                ...
                if (null == c)
                  throw new Error(
                    "Cannot find Magical Property for id: ".concat(a.id),
                  );
                if (c.sP) {
                  var l = a.values[n++];
                  switch (
                    (14 === c.dF && (l |= (8191 & a.values[n++]) << 3), c.e)
                  ) {
                    case 1:
                    default:
                      break;
        ...
        (t.readCharItems = function (e, t, r, n) {
          return i(this, void 0, void 0, function () {
            ...
            return a(this, function (a) {
              switch (a.label) {
                case 0:
                  return (i = e), [4, _(t, r, e.header.version, n, e)];
                case 1:
          ...
          (t.writeCharItems = function (e, t, r, n) {
            return i(this, void 0, void 0, function () {
              var i, s, o;
              return a(this, function (a) {
                switch (a.label) {
                  ...
                  case 1:
                    return o.apply(s, [a.sent()]), [2, i.ToArray()];
                }
              });
            });
          }),
                ...
                switch (a.label) {
                  case 0:
                    if (((e.merc_items = []), "jf" !== t.ReadString(2))) {
                      if (1 === (null == e ? void 0 : e.header.level))
                        return [2];
                      throw new Error(
                    ...
                    return e.header.merc_id &&
                      0 !== parseInt(e.header.merc_id, 16)
                      ? ((i = e), [4, _(t, r, e.header.version, n, e)])
                      : [3, 2];
                  case 1:
          ...
          (t.writeMercItems = function (e, t, r, n) {
            return i(this, void 0, void 0, function () {
              var i, s, o;
              return a(this, function (a) {
                switch (a.label) {
                    ...
                    return (
                      ...
                      e.header.merc_id && 0 !== parseInt(e.header.merc_id, 16)
                        ? ((e.merc_items = e.merc_items || []),
                          (o = (s = i).WriteArray),
                          [4, f(e.merc_items, t, r, n)])
                        : [3, 2]
                    );
                  case 1:
                    o.apply(s, [a.sent()]), (a.label = 2);
                  case 2:
                    return [2, i.ToArray()];
                }
              });
                ...
                switch (a.label) {
                  case 0:
                    ...
                    return 1 !== t.ReadUInt8()
                      ? [3, 2]
                      : ((i = e), [4, h(t, r, e.header.version, n)]);
                  case 1:
          ...
          (t.writeGolemItems = function (e, t, r, n) {
            return i(this, void 0, void 0, function () {
              var i, s, o;
              return a(this, function (a) {
                switch (a.label) {
                  case 0:
                    return (
                      ...
                      e.golem_item
                        ? (i.WriteUInt8(1),
                          (o = (s = i).WriteArray),
                          [4, p(e.golem_item, t, r, n)])
                        : [3, 2]
                    );
                  case 1:
                    return o.apply(s, [a.sent()]), [3, 3];
                  case 2:
          ...
          (t.writeCorpseItem = function (e, t, r, n) {
            return i(this, void 0, void 0, function () {
              var i, s, o;
              return a(this, function (a) {
                switch (a.label) {
          ...
          (t.readItem = h),
          (t.writeItem = p),
          (t._readMagicProperties = m),
          (t._writeMagicProperties = y);
      },
      654: function (e, t, r) {
        var i =
            (this && this.__awaiter) ||
        ...
        (t.readSkills = function (e, t, r) {
          var i = (0, s.getConstantData)(r, e.header.version);
          e.skills = [];
          var a = o[e.header.class];
          if ("if" !== t.ReadString(2)) {
            if (1 === e.header.level) return;
            throw new Error(
              "Skills header 'if' not found at position ".concat(t.offset - 16),
            );
          }
          for (var n = 0; n < 30; n++) {
            var c = a + n;
      ...
      377: (e, t) => {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.nameRegex = void 0),
          (t.nameRegex = /^[A-Za-z](?=.{0,14}$)[A-Za-z]*[A-Za-z\-_][A-Za-z]+$/);
      },
      106: (e, t, r) => {
        Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        function c(e) {
          ...
          t.length = 768;
          var r =
            +e.act_v.completed || +e.act_v.eve_of_destruction.b0_is_completed;
          return t
            ...
            .WriteUInt16(
              +e.act_i.completed ||
                +e.act_i.sisters_to_the_slaughter.b0_is_completed,
            )
            .WriteUInt16(
              +e.act_ii.introduced ||
                +e.act_i.sisters_to_the_slaughter.b0_is_completed,
            ...
            .WriteUInt16(
              +e.act_ii.completed || +e.act_ii.the_seven_tombs.b0_is_completed,
            )
            .WriteUInt16(
              +e.act_iii.introduced ||
                +e.act_ii.the_seven_tombs.b0_is_completed,
            )
            ...
            .WriteUInt16(
              +e.act_iii.completed || +e.act_iii.the_guardian.b0_is_completed,
            )
            .WriteUInt16(
              +e.act_iv.introduced || +e.act_iii.the_guardian.b0_is_completed,
            )
            .WriteArray(d(e.act_iv.the_fallen_angel))
            .WriteArray(d(e.act_iv.terrors_end))
            .WriteArray(d(e.act_iv.hellforge))
            .WriteUInt16(
              +e.act_iv.completed || +e.act_iv.terrors_end.b0_is_completed,
            )
            .WriteArray(new Uint8Array(6))
            .WriteUInt16(
              +e.act_v.introduced || +e.act_iv.terrors_end.b0_is_completed,
            )
        ...
        function l(e) {
          var t = {},
            r = new i.BitReader(e);
          return (
            (t.b0_is_completed = 1 === r.ReadBit()),
            (t.b1_is_requirement_completed = 1 === r.ReadBit()),
            (t.b2_is_received = 1 === r.ReadBit()),
            1 === r.ReadBit() && (t.b3_left_town = !0),
            1 === r.ReadBit() && (t.b4_entered_area = !0),
            1 === r.ReadBit() && (t.b5_custom1 = !0),
            1 === r.ReadBit() && (t.b6_custom2 = !0),
            1 === r.ReadBit() && (t.b7_custom3 = !0),
            1 === r.ReadBit() && (t.b8_custom4 = !0),
            1 === r.ReadBit() && (t.b9_custom5 = !0),
            1 === r.ReadBit() && (t.b10_custom6 = !0),
            1 === r.ReadBit() && (t.b11_custom7 = !0),
            (t.b12_closed = 1 === r.ReadBit()),
            (t.b13_done_recently = 1 === r.ReadBit()),
            1 === r.ReadBit() && (t.b14_completed_now = !0),
            1 === r.ReadBit() && (t.b15_completed_before = !0),
            t
          );
        }
        function d(e) {
          ...
          return (
            (t.length = 16),
            t.WriteBit(+e.b0_is_completed),
            t.WriteBit(+e.b1_is_requirement_completed),
            t.WriteBit(+e.b2_is_received),
            t.WriteBit(+e.b3_left_town),
            t.WriteBit(+e.b4_entered_area),
            t.WriteBit(+e.b5_custom1),
            t.WriteBit(+e.b6_custom2),
            t.WriteBit(+e.b7_custom3),
            t.WriteBit(+e.b8_custom4),
            t.WriteBit(+e.b9_custom5),
            t.WriteBit(+e.b10_custom6),
            t.WriteBit(+e.b11_custom7),
            t.WriteBit(+e.b12_closed),
            t.WriteBit(+e.b13_done_recently),
            t.WriteBit(+e.b14_completed_now),
            t.WriteBit(+e.b15_completed_before),
            t.ToArray()
          );
        }
        function u(e) {

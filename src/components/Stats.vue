...
const xp = [
    ...
    681027665, 742730244, 809986056, 883294891, 963201521, 1050299747,
    1145236814, 1248718217, 1361512946, 1484459201, 1618470619, 1764543065,
    1923762030, 2097310703, 2286478756, 2492671933, 2717422497, 2962400612,
    3229426756, 3520485254, 3837739017,
]
...
export default {
    ...
    data() {
        return {
            stats: window[`${window.work_mod}_constants_${window.work_version}`]
                .magical_properties,
        }
    },
    watch: {
        'save.header.level': function (level, s) {
            ...
            for (const cCode in constants.classes) {
                ...
                if (stat.n === this.save.header.class) {
                    ...
                    this.save.attributes.hitpoints +=
                        (newLevel * stat.s.lpl) / 4

                    this.save.attributes.maxstamina +=
                        (newLevel * stat.s.spl) / 4
